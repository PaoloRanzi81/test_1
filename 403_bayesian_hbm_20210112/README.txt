...
AUTHOR: Paolo Ranzi
README FILE VERSION (LAST UPDATE): 20201216


Python 3.6.9 has been used. For each step the specific Python script has been mentioned, accordingly. At the begginning of EACH script we have to make sure of setting custom-made parameters/pieces of information: 
